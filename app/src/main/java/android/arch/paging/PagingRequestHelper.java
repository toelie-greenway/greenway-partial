 ...
 *
 * <p>A rwcp usage of this class to limit requests looks like this:
 *
 * <pre>
 ...
 *                 helperCallback -> api.getTopBefore(itemAtFront.getTitle(), 10).enqueue(
 ...
 *                 helperCallback -> api.getTopBefore(itemAtEnd.getTitle(), 10).enqueue(
 *                         new Callback&lt;ApiResponse>() {
 *                             {@literal @}Override
 *                             public void onResponse(Call&lt;ApiResponse> call,
 *                                     Response&lt;ApiResponse> response) {
...
public class PagingRequestHelper {
    ...
    private String getErrorMessage(StatusReport report) {
        for (RequestType requestType : RequestType.values()) {
            Throwable throwable = report.getErrorFor(requestType);
            if (throwable instanceof IOException) {
                return CommonConstants.NETWORK_ERROR_MESSAGE;
    ...
    public enum RequestType {
        /**
         * Corresponds to an initial request made to a {@link DataSource} or the empty state for a
         * {@link androidx.paging.PagedList.BoundaryCallback BoundaryCallback}.
         */
        INITIAL,
        /**
         * Corresponds to the {@code loadBefore} calls in {@link DataSource} or {@code
         * onItemAtFrontLoaded} in {@link androidx.paging.PagedList.BoundaryCallback
         * BoundaryCallback}.
         */
        BEFORE,
        /**
         * Corresponds to the {@code loadAfter} calls in {@link DataSource} or {@code
         * onItemAtEndLoaded} in {@link androidx.paging.PagedList.BoundaryCallback
         * BoundaryCallback}.
         */
        AFTER
    }

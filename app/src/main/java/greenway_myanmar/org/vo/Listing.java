...
public class Listing<T> {
    ...
    public Listing(LiveData<PagedList<T>> pagedList, LiveData<Integer> itemCount, LiveData<NetworkState> networkState, LiveData<NetworkState> refreshState, RefreshCallback refreshCallback, RetryCallback retryCallback) {
        this.pagedList = pagedList;

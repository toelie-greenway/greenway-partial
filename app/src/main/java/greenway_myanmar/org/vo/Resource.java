...
import static greenway_myanmar.org.vo.Status.ERROR;
import static greenway_myanmar.org.vo.Status.LOADING;
import static greenway_myanmar.org.vo.Status.SUCCESS;
...
public class Resource<T> {
    ...
    public Resource(@NonNull Status status, @Nullable T data, @Nullable String message, @Nullable int code) {
        this.status = status;
        this.data = data;
    ...
    public static <T> Resource<T> success(@Nullable T data) {
        return new Resource<>(SUCCESS, data, null, 200);
    }
    ...
    public static <T> Resource<T> error(String msg) {
        return new Resource<>(ERROR, null, msg, 500);
    }

        ...
        context.theme
            ...
            .apply {
                try {
                    val textAppearance =
                        getResourceId(
                            R.styleable.GreenWayLargeSwitchOptionInputView_android_textAppearance,
                            0
                        )
                    setTextAppearance(textAppearance)

                    val label =
                        getString(R.styleable.GreenWayLargeSwitchOptionInputView_android_label)
                            ?: ""
                    if (label.isNotEmpty()) {
                        setLabel(label)
                    }
                    ...
                    val text =
                        getString(R.styleable.GreenWayLargeSwitchOptionInputView_android_text) ?: ""
                    setText(text)
                } finally {
                    recycle()
                }

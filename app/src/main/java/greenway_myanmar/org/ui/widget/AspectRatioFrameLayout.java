...
/**
 * Extension of LinearLayout that assumes a measured (non-zero) width and sets the
...
public class AspectRatioFrameLayout extends FrameLayout {
    ...
    public AspectRatioFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.AspectRatioFrameLayout_frameAspectRatio)) {
            mAspectRatio = a.getFloat(R.styleable.AspectRatioFrameLayout_frameAspectRatio, 0);
        }

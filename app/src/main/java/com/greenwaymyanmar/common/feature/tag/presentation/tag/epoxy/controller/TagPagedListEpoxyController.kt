 ...
 */
abstract class TagPagedListEpoxyController<F, S>(
    /**
    ...
    abstract fun isFirstModel(boundModel: EpoxyModel<*>): Boolean
    abstract fun isSecondModel(boundModel: EpoxyModel<*>): Boolean

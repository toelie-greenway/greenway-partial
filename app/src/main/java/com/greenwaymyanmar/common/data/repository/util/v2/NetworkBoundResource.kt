...
constructor(private val appExecutors: AppExecutors) {
  ...
  protected open fun processResponse(
    response: ApiSuccessResponse<AsylSuccessResponse<RequestType>>
  ) = response.body

  @WorkerThread protected abstract fun saveCallResult(item: AsylSuccessResponse<RequestType>)

  @MainThread protected abstract fun shouldFetch(data: ResultType?): Boolean

  @MainThread protected abstract fun loadFromDb(): LiveData<ResultType>

  @MainThread
  protected abstract fun createCall(): LiveData<ApiResponse<AsylSuccessResponse<RequestType>>>
}
